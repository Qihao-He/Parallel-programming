...
#define memorysize 1e3
/* True value of Pi from Wolframalpha www.wolframalpha.com #1000 after decimal*/
...
/* 3*100000000^0 + 14159256*100000000^(-1) + 35897932*100000000^(-2)+...

//3.14159265358979323846264338327950288419716939937510582097494459230781640628620899862803482534211706798 //100 digits
Use array instead of double precision data, use hexadecimal to store array can
highly utilize the RAM, also it can make the carry calculation faster. However,
when output and tranform into decimal takes a lot of calculation O(N^2),
sometimes longer than calculate pi itself. */
double truepivalue(){	//hexadecimal
	int n
